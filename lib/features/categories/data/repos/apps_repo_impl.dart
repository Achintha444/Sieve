...
class AppsRepoImpl implements AppsRepo {
  ...
  AppsRepoImpl(
      {@required this.networkInfo, @required this.appsRemoteDatasource});

  @override
  Future<Either<Faliure, List<App>>> loadApps(
      LoginUser user, int categoryId) async {
  ...
  @override
  Future<Either<Faliure, List<App>>> loadAppsSearch(LoginUser user) async {
    if (await networkInfo.isConnected) {
      try {
