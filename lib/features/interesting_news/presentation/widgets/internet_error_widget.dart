...
class InternetErrorWidget extends StatelessWidget {
  ...
  const InternetErrorWidget({Key key, @required this.user}) : super(key: key);
  ...
  void _dispatchEvent(BuildContext context) {
    print ('assaas');
    BlocProvider.of<InterestingNewsBloc>(context).dispatch(
        LoadInterestingNewsEvent(user: user)
    );
  }
}
