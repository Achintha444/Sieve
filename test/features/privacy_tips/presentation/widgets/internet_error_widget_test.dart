...
void main() {
  ...
  setUp(() {
    ...
    event = new LoadPrivacyTipsEvent(user: loginUser);
  });
  ...
  testWidgets('InternetErrorWidget - PrivacyTips', (WidgetTester tester) async {
    ...
    await tester.pump();
    verify(mockPrivacyTipsBloc.dispatch(event));
  });
}
